        ...
        stage('Parameters') {
            steps {
                script {
                    properties([
                        parameters([
                            choice(name:"engineName",choices:['c','a'],description: "Choose Engine"),
